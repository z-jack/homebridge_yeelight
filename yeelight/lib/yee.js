...
YeeDevice = function (did, loc, model, power, bri,
    ...
    this.setTemp = function (value) {
        var req = {
            id: 1, method: 'set_ct_abx',
            params: [Math.floor((value - 140) / (500 - 140) * (2700 - 6500) + 6500), 'smooth', 500]
        };
        this.sendCmd(req);
    }.bind(this);
...
exports.YeeAgent = function (ip, handler) {
    ...
    this.handleDiscoverMsg = function (message, from) {
        ...
        if (model == "desklamp") {
            sat = Math.floor((ct - 2700) / (6500 - 2700) * (140 - 500) + 500);
            sat.toString();
        }
